<script>
	...
	import credly from '$lib/images/credly.svg';
</script>
		...
		<div class="flex flex-row gap-4">
			<div class="flex flex-col gap-2">
				<p class="flex items-center gap-2">
					<img class="w-[1.5em] h-[1.5em] object-contain" src={address} alt="Address " /> Dhanmondi, Dhaka
				</p>
				<p class="flex items-center gap-2">
					<img class="w-[1.5em] h-[1.5em] object-contain" src={gmail} alt="Gmail " /> abirh364@gmail.com
				</p>
				<p class="flex items-center gap-2">
					<img class="w-[1.5em] h-[1.5em] object-contain" src={github} alt="GitHub " />
					<a href="https://github.com/abir364">abirh364</a>
				</p>
			</div>
			<div class="flex flex-col gap-2">
				<p class="flex items-center gap-2">
